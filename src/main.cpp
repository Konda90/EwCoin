...
uint256 hashGenesisBlock("0xa6e4ee22e90b62e2fb797200d59556ff12d6e648d62174ddc0bc29c8381bfed4");
...
const string strMessageMagic = "EwiCoin Signed Message:\n";
...
static const int64 nTargetTimespan = 1 * 24 * 60 * 60; // EwiCoin: 1 days
static const int64 nTargetSpacing = 120; // EwiCoin: 2 minute blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal ewicoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "EwiCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xa6e4ee22e90b62e2fb797200d59556ff12d6e648d62174ddc0bc29c8381bfed4");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Traditionally one puts something timely here coinciding with Anno Nuovo";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1483349953; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 88008;

        if (fTestNet)
        {
            block.nTime    = 1483631996;
            block.nNonce   = 88008;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xf36fb6d00aebe58ecca0b85316862cb038792a6072990271d5ae1224baba9452"));
